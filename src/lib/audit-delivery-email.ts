...
export const BILLGUARDED_PROMOTIONAL_EMAIL =
  `everton@${BILLGUARDED_EMAIL_DOMAIN}`;
export const BILLGUARDED_SUPPORT_EMAIL =
  `support@${BILLGUARDED_EMAIL_DOMAIN}`;
export const BILLGUARDED_TRANSACTIONAL_EMAIL =
  `notifications@${BILLGUARDED_EMAIL_DOMAIN}`;
export const BILLGUARDED_TRANSACTIONAL_SENDER =
  `BillGuarded <${BILLGUARDED_TRANSACTIONAL_EMAIL}>`;
export const BILLGUARDED_LEGACY_SUPPORT_SENDER =
...
export function buildAuditCompletionEmail(input: {
  ...
  return {
    from: BILLGUARDED_TRANSACTIONAL_SENDER,
